...
import dev.einsjannis.compiler.llvm.LocalFunction
...
class FunctionGeneration(val module: Module, val function: LocalFunction) {
	...
	fun Module.function(function: FunctionImplementationDefinition): LocalFunction =
